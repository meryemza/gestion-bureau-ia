...
<head>
    ...
    <style>
        ...
        h1 { color: #FBD9FA; margin-bottom: 10px; }
...
<body>
    <div class="header">
        <h1>Contrat à Durée Déterminée (CDD)</h1>
    </div>
    ...
    <div class="article">
        ...
        Le présent contrat est conclu pour une durée déterminée du {{ $contrat->date_debut ?? 'N/A' }} au {{ $contrat->date_fin ?? 'N/A' }}.
    </div>
    <div class="article">
